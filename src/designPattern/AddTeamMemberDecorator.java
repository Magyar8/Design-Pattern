 ...
 */
public class AddTeamMemberDecorator extends TeamMemberDecorator {
	/** Constructor that calls the constructor of the superclass */
	public AddTeamMemberDecorator(Decorator decoratedTeamMember) {
		super(decoratedTeamMember);
	}

	/** Declarat the team member  */
	@Override
	public void decorate() {
		decoratedTeamMember.decorate();
		addTeamMember(decoratedTeamMember);
	}

	private void addTeamMember(Decorator decoratedTeamMember) {
		System.out.println(" has been add to team.");
	}
}